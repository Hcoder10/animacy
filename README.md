...
- **Data:** v1 trained on 6 clips (20.5 min); the corpus is now 73 license-verified clips, 321 valid minutes, 37 speakers, ~12 languages ([HF dataset](https://huggingface.co/datasets/squaredcuber/animacy-human-motion)).
...
- The learned model does not beat shuffled audio on beat timing even at 150 min (docs/RESULTS.md, v2a); retrieval over the 321-minute corpus is the shipped default.
